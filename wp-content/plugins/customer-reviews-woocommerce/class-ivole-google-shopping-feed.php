	...
	public static function get_field( $field, $review ) {
		...
		switch ( $field_type ) {
			...
			case 'attribute':
				...
				break;
			case 'meta':
				$value = get_post_meta( $review->comment_post_ID, $field_key, true );
				break;
		}
