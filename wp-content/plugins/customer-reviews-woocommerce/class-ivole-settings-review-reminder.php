                    ...
                    if (jQuery('#ivole_email_from').length > 0) {
                        ...
                        jQuery.post(ajaxurl, data, function(response) {
                            ...
                            if ('<?php echo __( 'Active', IVOLE_TEXT_DOMAIN ); ?>' === response.license) {
                                ...
                                jQuery('#ivole_email_from_status').html( 'Review reminders are sent by CR from \'feedback@cusrev.com\'. This indicates to customers that review process is independent and trustworthy. \'From Address\' can be modified in the <a href="<?php echo admin_url( 'admin.php?page=ivole-reviews-settings&tab=premium' ); ?>">premium version</a> of the plugin.' );
                                jQuery('#ivole_email_from_name_status').html( 'Since review invitations are sent via CR, \'From Name\' will be based on \'Shop Name\' (see above) with a reference to CR. This field can be modified in the <a href="<?php echo admin_url( 'admin.php?page=ivole-reviews-settings&tab=premium' ); ?>">premium version</a> of the plugin.' );
